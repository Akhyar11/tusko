...
class UpdateExpeditionRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'code' => ['sometimes', 'required', 'string', 'min:2', 'max:50'],
            'service' => ['sometimes', 'required', 'string', 'min:1', 'max:100'],
            'service_grade' => ['nullable', 'string', 'max:50'],
            'category' => ['nullable', 'string', 'max:50'],
            'etd' => ['sometimes', 'required', 'string', 'max:50'],
    ...
    {
        return [
            'name.required' => 'Nama ekspedisi tidak boleh kosong.',
            'name.min' => 'Nama ekspedisi minimal 2 karakter.',
            'code.required' => 'Kode ekspedisi tidak boleh kosong.',
            'service.required' => 'Nama layanan kurir tidak boleh kosong.',
            'etd.required' => 'Estimasi pengiriman (ETD) tidak boleh kosong.',
