...
class MenuSeeder extends Seeder
{
    ...
    private const MENUS = [
        ...
        ['environment' => 'admin', 'section' => 'Katalog & Inventaris', 'label' => 'Stock Opname', 'sublabel' => 'Sesi hitung fisik & penyesuaian', 'path_prefix' => '/admin/stock-opname', 'view_key' => 'stock-opname', 'icon' => 'ClipboardCheck', 'feature_flag' => 'feature_flags.stock_menu', 'sort_order' => 24],
        ...
        ['environment' => 'admin', 'section' => 'Pemasaran & Promo', 'label' => 'Moderasi Ulasan', 'sublabel' => 'Tinjau ulasan & rating produk', 'path_prefix' => '/admin/reviews', 'view_key' => 'reviews-admin', 'icon' => 'Star', 'feature_flag' => null, 'sort_order' => 46],
        ...
        ['environment' => 'admin', 'section' => 'Pengguna & Akses', 'label' => 'Role → Menu Mapping', 'sublabel' => 'Matriks centang akses menu per role', 'path_prefix' => '/admin/role-menu', 'view_key' => 'role-menu', 'icon' => 'LayoutGrid', 'feature_flag' => null, 'sort_order' => 56],
