...
echo "🔧 [Tusko Git Hooks Setup] Mengonfigurasi git core.hooksPath ke folder .githooks..."
...
echo "✅ [Tusko Git Hooks Setup] Berhasil! Git hooks telah aktif di .githooks."
echo "💡 Pre-commit auditor kini otomatis berjalan setiap kali tim melakukan 'git commit'."
